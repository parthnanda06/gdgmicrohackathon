      ...
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: 440, padding: '0 20px' }}>
          ...
          <div style={{ position: 'relative', display: 'inline-block' }}>
            ...
            <motion.div
              ...
              style={{
                ...
                background: 'linear-gradient(135deg, rgba(124,92,255,0.3), rgba(0,217,255,0.3))',
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: 14, marginTop: 6 }}>
            Build habits. Gain XP. Beat procrastination.
          </p>
        </motion.div>
        ...
        >
          {['⚡ XP System', '🔥 Streaks', '🏆 Achievements'].map(b => (
            <span key={b} style={{
        ...
        >
          {step === 'main' ? (
            <>
              ...
              <motion.button
                ...
                style={{
                  ...
                  cursor: 'pointer', fontSize: 15, fontWeight: 600, color: 'white',
                  fontFamily: 'inherit',
            ...
            <form onSubmit={handleNameSubmit}>
              <p style={{ color: 'var(--text-muted)', fontSize: 14, marginBottom: 16, textAlign: 'center' }}>
              ...
              <button
                ...
                style={{
                  ...
                  width: '100%', marginTop: 12, cursor: 'pointer', fontSize: 13,
                  fontFamily: 'inherit',
                }}
              >
                ← Back
